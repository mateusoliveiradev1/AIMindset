...
// URLs únicas para cada seção (garantindo que não há duplicatas)
const uniqueImageUrls = {
  hero: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1200&h=600&fit=crop&crop=center',
  sectors: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1000&h=500&fit=crop&crop=center', // Mudança: nova imagem para setores
...
// Conteúdo corrigido sem a imagem hero duplicada no início
const correctedContent = `# 🚀 Inovação Disruptiva: Como Startups Estão Mudando o Mundo
...
![Setores Revolucionados](${uniqueImageUrls.sectors})
*Múltiplos setores sendo transformados simultaneamente pela inovação disruptiva*

### 🚗 **Transporte: A Mobilidade Reinventada**

![Transporte Inovador](${uniqueImageUrls.transport})
*A revolução da mobilidade urbana através de tecnologia e sustentabilidade*
...
![Economia Compartilhada](${uniqueImageUrls.sharing})
...
![Fintech Revolution](${uniqueImageUrls.fintech})
...
![Educação Online](${uniqueImageUrls.education})
...
![Pilares da Disrupção](${uniqueImageUrls.pillars})
...
![Inteligência Artificial](${uniqueImageUrls.ai})
...
![Casos de Sucesso](${uniqueImageUrls.success})
...
![Futuro da Inovação](${uniqueImageUrls.future})
...
![Conclusão](${uniqueImageUrls.conclusion})
...
async function fixImageDuplicates() {
  try {
    ...
    // Atualizar o artigo com o conteúdo corrigido
    const { data: updatedArticle, error: updateError } = await supabase
      .from('articles')
      .update({
        content: correctedContent,
        image_url: uniqueImageUrls.hero, // Manter a imagem hero apenas como image_url
    ...
    console.log('\n✅ CORREÇÕES APLICADAS:');
    console.log('🔧 Removida duplicata da imagem hero no conteúdo');
    console.log('🖼️ Imagem hero mantida apenas como image_url do artigo');
    console.log('🔄 Nova imagem para seção "Setores Revolucionados"');
    console.log('✅ Todas as seções agora têm imagens únicas');
    console.log('✅ Seção "Futuro da Inovação" mantém sua imagem específica');
    
    console.log('\n🖼️ ESTRUTURA FINAL DAS IMAGENS:');
    console.log(`1. Hero (image_url): ${uniqueImageUrls.hero}`);
    console.log(`2. Setores: ${uniqueImageUrls.sectors}`);
    console.log(`3. Transporte: ${uniqueImageUrls.transport}`);
    console.log(`4. Economia Compartilhada: ${uniqueImageUrls.sharing}`);
    console.log(`5. Fintech: ${uniqueImageUrls.fintech}`);
    console.log(`6. Educação: ${uniqueImageUrls.education}`);
    console.log(`7. Pilares: ${uniqueImageUrls.pillars}`);
    console.log(`8. IA: ${uniqueImageUrls.ai}`);
    console.log(`9. Casos de Sucesso: ${uniqueImageUrls.success}`);
    console.log(`10. Futuro da Inovação: ${uniqueImageUrls.future}`);
    console.log(`11. Conclusão: ${uniqueImageUrls.conclusion}`);
