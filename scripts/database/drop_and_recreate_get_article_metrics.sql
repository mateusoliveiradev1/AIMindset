-- 🎯 DROPAR E RECRIAR FUNÇÃO get_article_metrics COM MÉTRICAS DE ENGAJAMENTO
...
DROP FUNCTION IF EXISTS get_article_metrics(UUID, UUID);

-- Recriar a função com os novos campos
