...
// Mapeamento das descrições melhoradas usando os slugs corretos do banco
const improvedDescriptions = {
  // Slugs que existem no banco (baseado na saída anterior)
...
async function updateCategoriesDescriptions() {
  try {
    ...
    // Primeiro, buscar todas as categorias para ver os slugs corretos
