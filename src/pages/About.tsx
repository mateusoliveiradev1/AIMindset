...
const About: React.FC = () => {
  ...
  // SEO para página About
  const { getMetadata } = useSEO({ 
    pageType: 'about',
    fallbackTitle: 'Sobre - AIMindset',
    fallbackDescription: 'Conheça a missão do AIMindset: democratizar o conhecimento sobre inteligência artificial e ajudar pessoas a serem mais produtivas.'
  });
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-primary-dark text-white">
          ...
          <div className="relative max-w-4xl mx-auto text-center">
            <div className="flex justify-center mb-6">
              <div className="p-4 bg-neon-gradient rounded-full animate-pulse">
                <Brain className="w-12 h-12 text-white" aria-label="Ícone do cérebro representando inteligência artificial" />
              </div>
            </div>
        ...
        {/* Stats Section */}
        <section className="py-16 px-4 sm:px-6 lg:px-8" aria-labelledby="stats-heading">
          <div className="max-w-6xl mx-auto">
            <h2 id="stats-heading" className="sr-only">Estatísticas do AIMindset</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {stats.map((stat, index) => (
                <Card key={index} className="p-6 text-center hover-lift glass-effect">
                  <div className="flex justify-center mb-3">
                    <stat.icon className="w-8 h-8 text-lime-green" aria-hidden="true" />
                  </div>
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="p-8 md:p-12 glass-effect">
              <div className="text-center mb-8">
                <h2 id="mission-heading" className="text-3xl md:text-4xl font-orbitron font-bold mb-4 text-lime-green">
                  Nossa Missão
                </h2>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8" aria-labelledby="values-heading">
          <div className="max-w-6xl mx-auto">
            <h2 id="values-heading" className="text-3xl md:text-4xl font-orbitron font-bold text-center mb-12 text-white">
              ...
              <Card className="p-6 hover-lift glass-effect group">
                <div className="flex justify-center mb-4">
                  <div className="p-3 bg-lime-green/20 rounded-full group-hover:bg-lime-green/30 transition-colors">
                    <Lightbulb className="w-8 h-8 text-lime-green" aria-hidden="true" />
                  </div>
                </div>
              ...
              <Card className="p-6 hover-lift glass-effect group">
                <div className="flex justify-center mb-4">
                  <div className="p-3 bg-neon-purple/20 rounded-full group-hover:bg-neon-purple/30 transition-colors">
                    <Target className="w-8 h-8 text-neon-purple" aria-hidden="true" />
                  </div>
                </div>
                <h3 className="text-xl font-orbitron font-semibold mb-3 text-white text-center">
                  Qualidade
              ...
              <Card className="p-6 hover-lift glass-effect group">
                <div className="flex justify-center mb-4">
                  <div className="p-3 bg-electric-blue/20 rounded-full group-hover:bg-electric-blue/30 transition-colors">
                    <Heart className="w-8 h-8 text-electric-blue" aria-hidden="true" />
                  </div>
                </div>
                <h3 className="text-xl font-orbitron font-semibold mb-3 text-white text-center">
                  Comunidade
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8" aria-labelledby="timeline-heading">
          <div className="max-w-4xl mx-auto">
            <h2 id="timeline-heading" className="text-3xl md:text-4xl font-orbitron font-bold text-center mb-12 text-white">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8" aria-labelledby="team-heading">
          <div className="max-w-6xl mx-auto">
            <h2 id="team-heading" className="text-3xl md:text-4xl font-orbitron font-bold text-center mb-12 text-white">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8" aria-labelledby="offer-heading">
          <div className="max-w-6xl mx-auto">
            <h2 id="offer-heading" className="text-3xl md:text-4xl font-orbitron font-bold text-center mb-12 text-white">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="p-6 hover-lift glass-effect group">
                <div className="flex justify-center mb-4">
                  <div className="p-3 bg-lime-green/20 rounded-full group-hover:bg-lime-green/30 transition-colors">
                    <BookOpen className="w-8 h-8 text-lime-green" aria-hidden="true" />
                  </div>
                </div>
                <h3 className="text-xl font-orbitron font-semibold mb-3 text-white text-center">
              ...
              <Card className="p-6 hover-lift glass-effect group">
                <div className="flex justify-center mb-4">
                  <div className="p-3 bg-neon-purple/20 rounded-full group-hover:bg-neon-purple/30 transition-colors">
                    <Code className="w-8 h-8 text-neon-purple" aria-hidden="true" />
                  </div>
                </div>
                <h3 className="text-xl font-orbitron font-semibold mb-3 text-white text-center">
                  Tutoriais Práticos
              ...
              <Card className="p-6 hover-lift glass-effect group">
                <div className="flex justify-center mb-4">
                  <div className="p-3 bg-electric-blue/20 rounded-full group-hover:bg-electric-blue/30 transition-colors">
                    <TrendingUp className="w-8 h-8 text-electric-blue" aria-hidden="true" />
                  </div>
                </div>
                <h3 className="text-xl font-orbitron font-semibold mb-3 text-white text-center">
                  Análises de Mercado
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="p-8 md:p-12 text-center glass-effect relative overflow-hidden">
              ...
              <div className="relative">
                <h2 id="cta-heading" className="text-3xl md:text-4xl font-orbitron font-bold mb-6 text-white">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link to="/artigos">
                    <Button variant="primary" size="lg" className="hover-lift" aria-label="Explorar artigos sobre inteligência artificial">
                  ...
                  <Link to="/newsletter">
                    <Button variant="outline" size="lg" className="hover-lift" aria-label="Assinar newsletter do AIMindset">
