    ...
    <>
      ...
      <Card className="w-full max-w-md bg-darker-surface/90 backdrop-blur-sm border border-neon-purple/20">
        <div className="p-8 space-y-6">
          ...
          {/* Google Login para Admins */}
          <div className="relative">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-neon-purple/30"></div>
            </div>
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-darker-surface text-futuristic-gray">ou</span>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <button
              onClick={async () => {
                try {
                  ...
                  if (googleError) {
                    console.error('❌ Erro Google OAuth:', googleError);
                    setError('Erro ao conectar com Google. Tente novamente.');
                    return;
                  }
                  
                  console.log('✅ Redirecionando para Google...');
                  // O redirecionamento automático já acontece pelo Supabase
              ...
              className="w-full flex items-center justify-center px-4 py-3 border border-neon-purple/30 rounded-lg shadow-sm bg-dark-surface/50 text-white hover:bg-dark-surface/70 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-neon-purple"
            >
            ...
            <p className="text-xs text-futuristic-gray text-center">
              Use seu email de admin Google para acessar o painel
            </p>
          </div>
