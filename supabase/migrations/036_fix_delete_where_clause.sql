-- Correção da função restore_from_backup - adicionar WHERE clause nos DELETEs
...
BEGIN
    ...
    -- Limpar dados atuais (ordem correta para evitar violação de FK)
...
COMMENT ON FUNCTION restore_from_backup() IS 'Função para restaurar dados do último backup - corrigida com WHERE clause nos DELETEs';