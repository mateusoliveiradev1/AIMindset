-- Migração: Atualizar sistema de alertas para usar Vercel Function em produção
-- Data: 2025-10-31
...
VALUES (
    'migration',
    'Sistema de alertas migrado para Vercel Function em produção',
    jsonb_build_object(
        'migration', '080_update_alert_system_vercel_production',
        'timestamp', now(),
