-- Corrigir erro do operador JSON na função cleanup_old_backups
-- Problema: "operator does not exist: json || json"
-- Solução: Usar jsonb_build_object para concatenar objetos JSON
...
COMMENT ON FUNCTION cleanup_old_backups() IS 'Função para limpeza de logs antigos de backup com correção do operador JSON';
