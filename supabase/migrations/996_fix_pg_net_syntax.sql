-- Migração: Corrigir sintaxe do pg_net
-- Data: 2025-10-31
-- Descrição: Usar net.http_request ao invés de net.http_post

-- Dropar função existente
DROP FUNCTION IF EXISTS call_nodejs_email_endpoint(jsonb, text[]);

-- Recriar função com sintaxe correta do pg_net
...
BEGIN
    ...
    -- Fazer a chamada HTTP usando pg_net com sintaxe correta
    BEGIN
