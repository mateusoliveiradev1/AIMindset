...
('home', 'AIMindset - Inteligência Artificial e Produtividade', 'Descubra como a inteligência artificial pode transformar sua produtividade. Artigos, dicas e insights sobre IA, automação e tecnologia.', ARRAY['inteligência artificial', 'IA', 'produtividade', 'automação', 'tecnologia'], 'https://aimindset.com.br/', 
  jsonb_build_object(
    '@context', 'https://schema.org',
    '@type', 'Organization',
    'name', 'AIMindset',
    'url', 'https://aimindset.com.br',
    'logo', 'https://aimindset.com.br/logo.png',
    'description', 'Descubra como a inteligência artificial pode transformar sua produtividade',
    'sameAs', ARRAY['https://twitter.com/aimindset', 'https://linkedin.com/company/aimindset']
  )
),
('about', 'Sobre - AIMindset', 'Conheça a missão do AIMindset: democratizar o conhecimento sobre inteligência artificial e ajudar pessoas a serem mais produtivas.', ARRAY['sobre', 'missão', 'inteligência artificial', 'equipe'], 'https://aimindset.com.br/sobre',
  jsonb_build_object(
    '@context', 'https://schema.org',
    '@type', 'AboutPage',
    'name', 'Sobre - AIMindset',
    'description', 'Conheça a missão do AIMindset',
    'url', 'https://aimindset.com.br/sobre'
  )
),
('contact', 'Contato - AIMindset', 'Entre em contato conosco. Tire suas dúvidas, envie sugestões ou colabore com o AIMindset.', ARRAY['contato', 'suporte', 'colaboração'], 'https://aimindset.com.br/contato',
  jsonb_build_object(
    '@context', 'https://schema.org',
    '@type', 'ContactPage',
...
('newsletter', 'Newsletter - AIMindset', 'Assine nossa newsletter e receba as últimas novidades sobre inteligência artificial e produtividade diretamente no seu email.', ARRAY['newsletter', 'assinatura', 'novidades', 'email'], 'https://aimindset.com.br/newsletter',
  jsonb_build_object(
    '@context', 'https://schema.org',
    '@type', 'WebPage',
    'name', 'Newsletter - AIMindset',
    'description', 'Assine nossa newsletter',
...
BEGIN
  ...
  SELECT COALESCE(NEW.published, false) INTO article_status;
  
  -- Só gerar metadados para artigos publicados
  IF article_status = false THEN
    RETURN NEW;
  END IF;
