-- Correção da função restore_from_backup - resolver ambiguidade de colunas
...
COMMENT ON FUNCTION restore_from_backup() IS 'Função para restaurar dados do último backup - corrigida para resolver ambiguidade de colunas';