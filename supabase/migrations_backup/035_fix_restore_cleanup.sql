-- Correção da função restore_from_backup - melhorar limpeza de dados
...
COMMENT ON FUNCTION restore_from_backup() IS 'Função para restaurar dados do último backup - corrigida para limpeza adequada';