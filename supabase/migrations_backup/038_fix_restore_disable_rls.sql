-- Correção da função restore_from_backup - desabilitar RLS temporariamente
...
BEGIN
    ...
    -- Desabilitar RLS temporariamente para permitir limpeza completa
...
COMMENT ON FUNCTION restore_from_backup() IS 'Função para restaurar dados do último backup - desabilitando RLS temporariamente';